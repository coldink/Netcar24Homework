<html>
<head><title>Hier können Sie Ihre Termine bearbeiten</title>
...
echo '<input type="submit" name="del" value="Löschen"><br><br>';
...
echo '<a href="http://localhost/Terminplaner/delbea.php?del=1&tnr='.$row[0].'&unr='.$row[1].'">Löschen</a>';
